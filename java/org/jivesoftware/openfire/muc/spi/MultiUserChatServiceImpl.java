/**
 * $RCSfile: MultiUserChatServerImpl.java,v $ $Revision: 3036 $ $Date:
 * 2005-11-07 15:15:00 -0300 (Mon, 07 Nov 2005) $
 *
 ...
 * when the Multi-User Chat service starts up.</p>
 *
...
public class MultiUserChatServiceImpl implements Component, MultiUserChatService,
     ...
     *
     * @param subdomain Subdomain portion of the conference services (for
     * example, conference for conference.example.org)
     * @param description Short description of service for disco and such. If
     * <tt>null</tt> or empty, a default value will be used.
     * @param isHidden True if this service should be hidden from services
     * views.
     * @throws IllegalArgumentException if the provided subdomain is an invalid,
     * according to the JID domain definition.
     */
     ...
     * requests.
     *
     * @param allowToDiscoverMembersOnlyRooms if the service should provide
     * information about non-public members-only rooms.
     */
     ...
     *
     * @param allowToDiscoverLockedRooms if the service should provide
     * information about locked rooms.
     */
     ...
     *
     * @param onlyLocal true if only users connected to this JVM will be
     ...
     *
     * @param resetAfter True if you want the counter to be reset after results
     * returned.
            ...
            for (MUCRoom room : rooms.values()) {
                if (canDiscoverRoom(room, senderJID)) {
                    answer.add(new DiscoItem(room.getRole().getRoleAddress(),
                            room.getNaturalLanguageName(), room.getDescription(), null, null));
                }
            }
        } else if (name != null && node == null) {
