...
public class DiscoItem implements Result {
     ...
     * @throws IllegalArgumentException If a required parameter was null, or if
     * the supplied 'action' parameter has another value than 'null', "update"
     * or "remove".
     */
    ...
    // Succeed
    public DiscoItem(JID jid, String name, String desc, String node, String action) {
        if (jid == null) {
            throw new IllegalArgumentException("Argument 'jid' cannot be null.");
        }
